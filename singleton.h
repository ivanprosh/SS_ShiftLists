/*
 * реализация для доступа по SSingleton::getInstance<T>()
 * не совсем удобна, но позволяет не заботиться о наследниках
 *
#ifndef SSINGLETON_H
#define SSINGLETON_H
...
private:
    static QMap<QString, SSingleton*> map;
};

Q_DECLARE_METATYPE(SSingleton*)

template<class Derived>
Derived& SSingleton::getInstance() {
    ...
    if (d == NULL) {
        Q_ASSERT("SSingleton::getInstance(): \"Derived\" in not a singleton");
    }
    return *d;
}
...
/*
 * используем реализацию библиотеки Loki (Alexandresku)
 */
////////////////////////////////////////////////////////////////////////////////
// The Loki Library
...
////////////////////////////////////////////////////////////////////////////////
    ...
    struct DefaultLifetime
    {
        ...
        { //throw std::logic_error("Dead Reference Detected");
            throw SYS::Error("Singleton: Dead Reference Detected");
        }
    };
